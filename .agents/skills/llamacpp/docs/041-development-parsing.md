---
title: Parsing
url: https://github.com/ggml-org/llama.cpp/blob/master/docs/development/parsing.md
source: git
fetched_at: 2026-04-28T09:49:25.0433362-03:00
rendered_js: false
optimized: true
summary: PEG parser library for model output — streaming, JSON, AST, GBNF grammar generation.
tags:
    - peg-parser
    - model-output
    - c-plus-plus
...
PEG parser in `common` library for parsing model output. Types prefixed `common_peg_*` = general use; `common_chat_peg_*` = model output specialized.

Features: streaming partial parsing, built-in JSON parsers, AST with semantic tagged nodes.

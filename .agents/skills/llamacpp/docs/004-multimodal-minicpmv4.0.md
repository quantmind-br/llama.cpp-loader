---
title: MiniCPM-V 4
url: https://github.com/ggml-org/llama.cpp/blob/master/docs/multimodal/minicpmv4.0.md
source: git
fetched_at: 2026-04-28T09:49:42.065426699-03:00
rendered_js: false
word_count: 59
summary: This document provides instructions for building llama.cpp and converting the MiniCPM-V 4 model into the GGUF format for local inference.
tags:
    - minicpm-v-4
    - llama-cpp
    - gguf-conversion
...
Download [MiniCPM-V-4](https://huggingface.co/openbmb/MiniCPM-V-4) PyTorch model from Hugging Face to `MiniCPM-V-4` folder.
...
Convert PyTorch model to GGUF files (pre-converted [gguf](https://huggingface.co/openbmb/MiniCPM-V-4-gguf) also available):
...
#minicpm-v-4 #llama-cpp #gguf-conversion #model-quantization

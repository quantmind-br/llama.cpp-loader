---
title: MiniCPM-o 2.6
url: https://github.com/ggml-org/llama.cpp/blob/master/docs/multimodal/minicpmo2.6.md
source: git
fetched_at: 2026-04-28T09:49:36.955793731-03:00
rendered_js: false
word_count: 69
summary: This document provides instructions for setting up, converting, and running the MiniCPM-o 2.6 multimodal model using the llama.cpp framework.
tags:
    - minicpm-o
    - llama-cpp
    - gguf-conversion
...
Currently supports minicpm-omni's image capabilities only; full-mode support is planned.

### Prepare models and code

Download [MiniCPM-o-2_6](https://huggingface.co/openbmb/MiniCPM-o-2_6) PyTorch model from Hugging Face to `MiniCPM-o-2_6` folder.
...
Convert PyTorch model to GGUF files (pre-converted [gguf](https://huggingface.co/openbmb/MiniCPM-o-2_6-gguf) also available):
...
#minicpm-o #llama-cpp #gguf-conversion #multimodal-inference
